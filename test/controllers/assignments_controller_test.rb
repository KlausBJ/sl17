...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create assignment' do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { person_id: @assignment.person_id, task_id: @assignment.task_id } }
    end
  ...
  test 'should update assignment' do
    patch assignment_url(@assignment), params: { assignment: { person_id: @assignment.person_id, task_id: @assignment.task_id } }
